            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="background-color:greenyellow; color:white;" href="{{url('my_appointment')}}">My Appointment</a>
                        </li>
    ...
    <div align="center" style="padding:70px;">
        <table>
            ...
            <tr style="background-color:black;" align="center">
                ...
                <td><a href="{{url('cancel_appoint',$appoints->id)}}" onclick="return confirm('Are you sure want to cancel?')" class="btn btn-danger">Cancel</a></td>
            </tr>
            @endforeach
        </table>
    </div>
